...
//prepare an empty reply
	...
	try {
		...
		if($method === "PUT") {
			...
			if(empty($_SESSION["user"]) === true || $_SESSION["user"]->getUserId()->toString() !== $userDetail->getUserDetailUserId()->toString()) {
				throw(new \InvalidArgumentException("You are not allowed to edit this user", 403));
			}
