...
//prepare an empty reply
			...
			try {
				...
				if(empty($_SESSION["userDetailId"]) === true || $_SESSION["userDetail"]->getUserDetailId()->toString() !== $userDetail->getUserDetailId()->getBytes()) {
					throw(new \InvalidArgumentException("You are not allowed to edit this user detail", 403));
				}

				// update all attributes
				$userDetail->setUserDetailId($requestObject->userDetailId);
				...
				$userDetail->setUserDetailUserId($requestObject->userDetailUserId);
